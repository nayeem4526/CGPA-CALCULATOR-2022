...
document.querySelector('#btn-sum').addEventListener('click',() => {
 ...
 // three input value [10% per] calculation
 let three_gpa_per=(three_gpa / 100) * 10;
 ...
 // five input value [20% per] calculation
 let five_gpa_per=(five_gpa / 100) * 20;
 ...
 // seven input value [20% per] calculation
 let seven_gpa_per=(seven_gpa / 100) * 20;
 ...
 let eight_gpa_per=(eight_gpa / 100) * 10;
 ...
 document.querySelector('.cgpa_output h2').innerHTML=`TOTAL CGPA = ${total_cgpa}`
 })
 
 document.querySelector('#btn-re').addEventListener('click',() =>{
   document.querySelector('.cgpa_output h2').innerHTML=`TOTAL CGPA =`
